...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react3.useState)(true);
  ...
  const onDocumentKeyUp = (0, import_react3.useCallback)(
    (e) => {
  ...
  const onDocumentMouseUp = (0, import_react3.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseOver = (0, import_react3.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
...
function useFocusOnShow(target, options = defaultOptions) {
  ...
  const autoFocusRef = (0, import_react7.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react7.useRef)(visible);
  useSafeLayoutEffect(() => {
...
function usePopper(props = {}) {
  ...
  const reference2 = (0, import_react8.useRef)(null);
  const popper2 = (0, import_react8.useRef)(null);
  const instance = (0, import_react8.useRef)(null);
  const placement = getPopperPlacement(placementProp, direction);
  const cleanup = (0, import_react8.useRef)(() => {
  });
  const setupPopper = (0, import_react8.useCallback)(() => {
    var _a;
  ...
  const referenceRef = (0, import_react8.useCallback)(
    (node) => {
  ...
  const getReferenceProps = (0, import_react8.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react8.useCallback)(
    (node) => {
  ...
  const getPopperProps = (0, import_react8.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowProps = (0, import_react8.useCallback)((props2 = {}, ref = null) => {
  ...
  const getArrowInnerProps = (0, import_react8.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react11.useState)(isOpen);
  const [once, setOnce] = (0, import_react11.useState)(false);
...
function useMenu(props = {}) {
  ...
  const focusMenu = (0, import_react13.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a;
      (_a = menuRef.current) == null ? void 0 : _a.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react13.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react13.useCallback)(() => {
    const id2 = setTimeout(() => {
  ...
  const onOpenInternal = (0, import_react13.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react13.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react13.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect(() => {
    timeoutIds.current.forEach((id2) => clearTimeout(id2));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react13.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react13.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react13.useCallback)(() => {
    var _a, _b;
  ...
  const rafId = (0, import_react13.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react13.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react13.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react13.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react13.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react13.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react14.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react15.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react16.isValidElement)(child) ? (0, import_react16.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
//# sourceMappingURL=chunk-KLSI2KD6.js.map
